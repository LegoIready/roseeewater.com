...
?>
<h1>Resources</h1>
<p>Internal and external resources about computing, education, and computing education.</p>
<h2>Rosa's Notas</h2>
...
<h2>Computing Education Researchers</h2>
<p>This is a partial list of computing education researchers that extends Amy J. Ko's <?php mention('https://faculty.washington.edu/ajko/cer','Computing Education Research FAQ'); ?>.</p>
    <script> echo_list("researchers", "resources"); </script>
</section>
<?php
include("footer.php");
?>